...
public static void main(String[] args) {
	...
	if(playerwins>computerwins) {
		JOptionPane.showMessageDialog(null,"Congratulations you won!!!!","  Hurray  ",JOptionPane.WARNING_MESSAGE);
	}
	else if(player.equals(computer)){
		JOptionPane.showMessageDialog(null,"Sorry the game is a tie try again....","oops",JOptionPane.ERROR_MESSAGE);
	}
	else {
		JOptionPane.showMessageDialog(null,"Sorry you lost the game :(","Bad luck",JOptionPane.ERROR_MESSAGE);
	}
	break;
